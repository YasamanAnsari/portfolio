...
export const socialsTitle = 'Connect me:';
export const linkedinUrl = 'https://www.linkedin.com/in/yasaman-ansari/';
export const githubUrl = 'https://github.com/YasamanAnsari';

export const summeryAboutMe = `I’m a developer who have been experiencing different fields of computer
		...
		list: [
			{
				...
				companyTitle: 'Huawei',
				duration: 'Sep 2020 – Oct 2021    1 year',
			},
			{
				jobTitle: 'Oracle Database Administrator',
				companyTitle: 'Avihang',
				duration: 'Feb 2019 – Dec 2019    11 mos',
			},
			{
				jobTitle: 'Web Developer',
				companyTitle: 'Idea System Pardaz corporation',
				duration: 'Apr 2016 – Nov 2018    2 yrs 8 mos',
			},
		],
	},
	educations: {
...
export const aboutMe = [
	...
	`In addition to the cool-looking world of machine learning, what draws me to it is that I have always considered my audiences' needs carefully, and machine learning is a valuable tool for identifying and satisfying those needs.`,
